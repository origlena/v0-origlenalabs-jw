  ...
  const subjects = [
    {
      ...
      icon: Dna,
      href: "/simulations?subject=biology",
      color: "biology",
      simulations: 3,
      featured: "DNA Double Helix",
    },
    {
    ...
    },
    {
      ...
      color: "chemistry",
      simulations: 3,
      featured: "Molecular Viewer",
    },
    {
      name: t("subjects.mathematics"),
      description: t("subjects.mathematics.desc"),
      icon: Calculator,
      href: "/simulations?subject=math",
      color: "mathematics",
      simulations: 2,
      featured: "3D Graphing",
    },
    {
